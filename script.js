...
function tileImagePicker(mineTileCounter, i){
    ...
    $("#"+i).append(`<img class="numberTile" id=${mineTileCounter} src="https://upload.wikimedia.org/wikipedia/commons/8/80/Minesweeper_0.svg"></img>`);
    }
    else if(mineTileCounter===1){
    $("#"+i).append(`<img class="numberTile" id=${mineTileCounter} src="https://upload.wikimedia.org/wikipedia/commons/c/ca/Minesweeper_1.svg"></img>`);
    }
    else if(mineTileCounter===2){
    $("#"+i).append(`<img class="numberTile" id=${mineTileCounter} src="https://upload.wikimedia.org/wikipedia/commons/4/44/Minesweeper_2.svg"></img>`);
    }
    else if(mineTileCounter===3){
    $("#"+i).append(`<img class="numberTile" id=${mineTileCounter} src="https://upload.wikimedia.org/wikipedia/commons/0/08/Minesweeper_3.svg"></img>`);
    }
    else if(mineTileCounter===4){
    $("#"+i).append(`<img class="numberTile" id=${mineTileCounter} src="https://upload.wikimedia.org/wikipedia/commons/4/4f/Minesweeper_4.svg"></img>`);
    }
    else if(mineTileCounter===5){
    $("#"+i).append(`<img class="numberTile" id=${mineTileCounter} src="https://upload.wikimedia.org/wikipedia/commons/4/46/Minesweeper_5.svg"></img>`);
    }
    else if(mineTileCounter===6){
    $("#"+i).append(`<img class="numberTile" id=${mineTileCounter} src="https://upload.wikimedia.org/wikipedia/commons/c/cc/Minesweeper_6.svg"></img>`);
    }
    else if(mineTileCounter===7){
    $("#"+i).append(`<img class="numberTile" id=${mineTileCounter} src="https://upload.wikimedia.org/wikipedia/commons/5/56/Minesweeper_7.svg"></img>`);
    }
    else if(mineTileCounter===8){
    $("#"+i).append(`<img class="numberTile" id=${mineTileCounter} src="https://upload.wikimedia.org/wikipedia/commons/0/0d/Minesweeper_8.svg"></img>`);
    }
